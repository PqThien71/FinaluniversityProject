...
img = "C:/Users/phamq/Desktop/yolo_3/dataTest/anh_test1.jpg"
classes = None  # tạo class từ file yolo.names
with open('D:/study/FinalProject_Thien_MTA/code/config/yolo.names', 'r') as f:
...
class Ui_MainWindow(object):
    ...
    def viewCam(self):
        ...
        listSanPham = []
        listSanPham = detection(image)
        listSanPhamTest = []
        listSanPhamTest = ['cam:200:0', 'xoai:100:0', 'tao:100:50']
        # print(listSanPham)
